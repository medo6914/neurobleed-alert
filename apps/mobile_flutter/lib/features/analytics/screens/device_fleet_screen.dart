          ...
          child: Column(
            ...
            children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Average Battery: ${data.averageBattery.toStringAsFixed(0)}%', style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600)),
                            Text('${data.lowBatteryCount} devices below 20%', style: theme.textTheme.labelSmall?.copyWith(color: theme.colorScheme.onSurfaceVariant)),
                          ],
                        ),
                      ),
                    ],
              ...
              if (data.byStatus.isNotEmpty) ...[
                SizedBox(height: NeuroSpacing.lg),
                Text('By Status', style: theme.textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                SizedBox(height: NeuroSpacing.sm),
                ...data.byStatus.map((s) => Padding(
                  ...
                  child: AppCard(
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Expanded(child: Text('${s['status'] ?? 'Unknown'}', style: theme.textTheme.bodyMedium)),
