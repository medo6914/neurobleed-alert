...
class TestPasswordPolicy:
    ...
    async def test_password_history_tracked(self, user_repo, seeded_hospital, seeded_user):
        updated = await user_repo.update(seeded_user.id, {
    ...
    async def test_account_lockout_tracking(self, user_repo, seeded_hospital, seeded_user):
        updated = await user_repo.update(seeded_user.id, {
            "login_attempts": 5,
