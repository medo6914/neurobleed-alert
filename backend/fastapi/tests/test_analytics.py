...
pytest.skip(
    "Requires FastAPI client fixture + analytics endpoints", allow_module_level=True
)
...
async def test_analytics_overview(client):
    ...
    response = await client.get(
        "/v1/analytics/overview", headers={"Authorization": f"Bearer {token}"}
    )
...
async def test_analytics_patients(client):
    await client.post(
        "/v1/auth/register",
        json={
            "email": "analytics_doc2@test.com",
            "password": "pass123",
            "full_name": "Dr. Analytics2",
            "role": "doctor",
        },
    )
    login = await client.post(
    ...
    response = await client.get(
        "/v1/analytics/patients", headers={"Authorization": f"Bearer {token}"}
    )
    assert response.status_code == 200
    data = response.json()
...
async def test_analytics_devices(client):
    await client.post(
        "/v1/auth/register",
        json={
            "email": "analytics_doc3@test.com",
            "password": "pass123",
            "full_name": "Dr. Analytics3",
            "role": "doctor",
        },
    )
    login = await client.post(
    ...
    response = await client.get(
        "/v1/analytics/devices", headers={"Authorization": f"Bearer {token}"}
    )
    assert response.status_code == 200
    data = response.json()
    assert "total" in data
...
async def test_analytics_alerts(client):
    await client.post(
        "/v1/auth/register",
        json={
            "email": "analytics_doc4@test.com",
            "password": "pass123",
            "full_name": "Dr. Analytics4",
            "role": "doctor",
        },
    )
    login = await client.post(
    ...
    response = await client.get(
        "/v1/analytics/alerts", headers={"Authorization": f"Bearer {token}"}
    )
    assert response.status_code == 200
    data = response.json()
    assert "total" in data
...
async def test_analytics_hospitals(client):
    await client.post(
        "/v1/auth/register",
        json={
            "email": "analytics_doc5@test.com",
            "password": "pass123",
            "full_name": "Dr. Analytics5",
            "role": "doctor",
        },
    )
    login = await client.post(
    ...
    response = await client.get(
        "/v1/analytics/hospitals", headers={"Authorization": f"Bearer {token}"}
    )
    assert response.status_code == 200
    data = response.json()
    assert "total_hospitals" in data
...
async def test_analytics_system_health(client):
    await client.post(
        "/v1/auth/register",
        json={
            "email": "analytics_doc6@test.com",
            "password": "pass123",
            "full_name": "Dr. Analytics6",
            "role": "doctor",
        },
    )
    login = await client.post(
    ...
    response = await client.get(
        "/v1/analytics/system-health", headers={"Authorization": f"Bearer {token}"}
    )
    assert response.status_code == 200
    data = response.json()
...
async def test_analytics_activity_feed(client):
    await client.post(
        "/v1/auth/register",
        json={
            "email": "analytics_doc7@test.com",
            "password": "pass123",
            "full_name": "Dr. Analytics7",
            "role": "doctor",
        },
    )
    login = await client.post(
    ...
    response = await client.get(
        "/v1/analytics/activity-feed?limit=10",
