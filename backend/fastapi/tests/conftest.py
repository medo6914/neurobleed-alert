...
@pytest.fixture
async def seeded_sensor_reading(sensor_reading_repo: SensorReadingRepository, seeded_patient, seeded_device):
...
@pytest.fixture
async def seeded_alert(alert_repo: AlertRepository, seeded_patient, seeded_device, seeded_sensor_reading):
...
@pytest.fixture
async def seeded_ai_report(ai_report_repo: AIReportRepository, seeded_patient, seeded_alert):
