...
class Device(
    ...
    device_type: Mapped[DeviceType] = mapped_column(
        SAEnum(DeviceType), nullable=False, default=DeviceType.NB_01
    )
    ...
    firmware_version: Mapped[str] = mapped_column(
        String(50), nullable=False, default="0.1.0"
    )
    ...
    status: Mapped[DeviceStatus] = mapped_column(
        SAEnum(DeviceStatus), nullable=False, default=DeviceStatus.OFFLINE
    )
