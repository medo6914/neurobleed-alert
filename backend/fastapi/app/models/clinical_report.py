...
class ClinicalReport(
    ...
    report_type: Mapped[str] = mapped_column(
        String(100), nullable=False, default="clinical_summary"
    )
    format: Mapped[ReportFormat] = mapped_column(
        SAEnum(ReportFormat), nullable=False, default=ReportFormat.PDF
    )
    status: Mapped[ReportStatus] = mapped_column(
        SAEnum(ReportStatus), nullable=False, default=ReportStatus.PENDING
    )
    ...
    include_shap: Mapped[bool] = mapped_column(
        Boolean, default=False, server_default="0"
    )
    include_trends: Mapped[bool] = mapped_column(
...
Index(
    "ix_clinical_reports_patient_status",
    ClinicalReport.patient_id,
