...
class KnowledgeBase(TimestampMixin, SoftDeleteMixin, VersionMixin, AuditMixin, FHIRMixin, Base):
    ...
    faiss_indexed: Mapped[bool] = mapped_column(Boolean, default=False, server_default="0")
...
Index("ix_knowledge_base_published", KnowledgeBase.is_published, KnowledgeBase.created_at.desc())
