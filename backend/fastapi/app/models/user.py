...
class User(TimestampMixin, SoftDeleteMixin, VersionMixin, Base):
    ...
    is_phone_verified: Mapped[bool] = mapped_column(Boolean, default=False, server_default="0")
    is_mfa_enabled: Mapped[bool] = mapped_column(Boolean, default=False, server_default="0")
    ...
    hospital = relationship("Hospital", back_populates="users", foreign_keys="User.hospital_id")
