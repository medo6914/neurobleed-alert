...
class Alert(
    TimestampMixin, SoftDeleteMixin, VersionMixin, FHIRMixin, MedicalCodeMixin, Base
):
    ...
    alert_type: Mapped[AlertType] = mapped_column(
        SAEnum(AlertType), nullable=False, default=AlertType.GENERAL
    )
    severity: Mapped[Severity] = mapped_column(
        SAEnum(Severity), nullable=False, default=Severity.MEDIUM
    )
