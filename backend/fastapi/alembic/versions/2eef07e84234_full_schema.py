...
def _create_enums():
    sa.Enum('admin', 'doctor', 'nurse', 'technician', 'patient', 'emergency', name='userrole').create(op.get_bind())
    sa.Enum('male', 'female', 'other', name='gender').create(op.get_bind())
    sa.Enum('A+', 'A-', 'B+', 'B-', 'AB+', 'AB-', 'O+', 'O-', name='bloodtype').create(op.get_bind())
    sa.Enum('low', 'medium', 'high', 'critical', 'unknown', name='risklevel').create(op.get_bind())
    sa.Enum('low', 'medium', 'high', 'critical', name='severity').create(op.get_bind())
    sa.Enum('icp_elevated', 'desaturation', 'bradycardia', 'tachycardia', 'hypotension', 'hypertension', 'arrhythmia', 'system', 'general', name='alerttype').create(op.get_bind())
    sa.Enum('NB-01', 'NB-02', name='devicetype').create(op.get_bind())
    sa.Enum('online', 'offline', 'error', 'maintenance', name='devicestatus').create(op.get_bind())
    sa.Enum('risk_assessment', 'bleeding_detection', 'icp_prediction', 'herniation_prediction', name='reporttype').create(op.get_bind())
    sa.Enum('low', 'medium', 'high', name='icprisk').create(op.get_bind())
    sa.Enum('low', 'medium', 'high', name='herniationrisk').create(op.get_bind())
    sa.Enum('general', 'specialized', 'teaching', 'clinic', 'research', name='hospitaltype').create(op.get_bind())
    sa.Enum('hospital', 'clinic', 'research_center', 'government', 'insurance', 'pharma', name='organizationtype').create(op.get_bind())
    sa.Enum('create', 'update', 'delete', 'publish', 'unpublish', name='knowledgeupdateaction').create(op.get_bind())
...
def upgrade() -> None:
    ...
    op.create_table('organizations',
        sa.Column('id', sa.Uuid(), nullable=False),
        sa.Column('name', sa.String(length=255), nullable=False),
        sa.Column('org_type', sa.Enum('hospital', 'clinic', 'research_center', 'government', 'insurance', 'pharma', name='organizationtype'), nullable=False),
    ...
    op.add_column('hospitals', sa.Column('hospital_type', sa.Enum('general', 'specialized', 'teaching', 'clinic', 'research', name='hospitaltype'), nullable=True))
    op.add_column('hospitals', sa.Column('is_deleted', sa.Boolean(), server_default='0', nullable=False))
    ...
    op.add_column('hospitals', sa.Column('version', sa.Integer(), server_default='1', nullable=False))
    ...
    op.add_column('hospitals', sa.Column('fhir_resource_type', sa.String(length=50), nullable=True))
    op.add_column('hospitals', sa.Column('fhir_id', sa.String(length=100), nullable=True))
    ...
    op.create_foreign_key('fk_hospitals_deleted_by_id', 'hospitals', 'users', ['deleted_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_hospitals_created_by_id', 'hospitals', 'users', ['created_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_hospitals_updated_by_id', 'hospitals', 'users', ['updated_by_id'], ['id'], ondelete='SET NULL')

    op.add_column('users', sa.Column('is_mfa_enabled', sa.Boolean(), server_default='0', nullable=False))
    ...
    op.create_foreign_key('fk_users_deleted_by_id', 'users', 'users', ['deleted_by_id'], ['id'], ondelete='SET NULL')
    ...
    op.add_column('patients', sa.Column('emergency_contact_relation', sa.String(length=50), nullable=True))
    ...
    op.add_column('patients', sa.Column('discharge_date', sa.DateTime(timezone=True), nullable=True))
    op.add_column('patients', sa.Column('department_id', sa.Uuid(), nullable=True))
    op.add_column('patients', sa.Column('is_deleted', sa.Boolean(), server_default='0', nullable=False))
    ...
    op.add_column('patients', sa.Column('fhir_resource_type', sa.String(length=50), nullable=True))
    op.add_column('patients', sa.Column('fhir_id', sa.String(length=100), nullable=True))
    op.add_column('patients', sa.Column('icd10_code', sa.String(length=20), nullable=True))
    op.add_column('patients', sa.Column('snomed_ct_code', sa.String(length=20), nullable=True))
    op.add_column('patients', sa.Column('loinc_code', sa.String(length=20), nullable=True))
    op.create_index(op.f('ix_patients_mrn'), 'patients', ['mrn'], unique=True)
    op.create_foreign_key('fk_patients_department_id', 'patients', 'departments', ['department_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_patients_deleted_by_id', 'patients', 'users', ['deleted_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_patients_created_by_id', 'patients', 'users', ['created_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_patients_updated_by_id', 'patients', 'users', ['updated_by_id'], ['id'], ondelete='SET NULL')
    ...
    op.add_column('devices', sa.Column('version', sa.Integer(), server_default='1', nullable=False))
    ...
    op.add_column('devices', sa.Column('fhir_resource_type', sa.String(length=50), nullable=True))
    ...
    op.create_foreign_key('fk_devices_hospital_id', 'devices', 'hospitals', ['hospital_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_devices_deleted_by_id', 'devices', 'users', ['deleted_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_devices_created_by_id', 'devices', 'users', ['created_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_devices_updated_by_id', 'devices', 'users', ['updated_by_id'], ['id'], ondelete='SET NULL')

    op.add_column('sensor_readings', sa.Column('fhir_resource_type', sa.String(length=50), nullable=True))
    op.add_column('sensor_readings', sa.Column('fhir_id', sa.String(length=100), nullable=True))
    op.add_column('sensor_readings', sa.Column('icd10_code', sa.String(length=20), nullable=True))
    op.add_column('sensor_readings', sa.Column('snomed_ct_code', sa.String(length=20), nullable=True))
    op.add_column('sensor_readings', sa.Column('loinc_code', sa.String(length=20), nullable=True))

    op.alter_column('alerts', 'acknowledged', new_column_name='is_acknowledged')
    op.add_column('alerts', sa.Column('is_resolved', sa.Boolean(), server_default='0', nullable=False))
    ...
    op.add_column('alerts', sa.Column('version', sa.Integer(), server_default='1', nullable=False))
    op.add_column('alerts', sa.Column('fhir_resource_type', sa.String(length=50), nullable=True))
    op.add_column('alerts', sa.Column('fhir_id', sa.String(length=100), nullable=True))
    op.add_column('alerts', sa.Column('icd10_code', sa.String(length=20), nullable=True))
    op.add_column('alerts', sa.Column('snomed_ct_code', sa.String(length=20), nullable=True))
    op.add_column('alerts', sa.Column('loinc_code', sa.String(length=20), nullable=True))
    op.create_foreign_key('fk_alerts_resolved_by', 'alerts', 'users', ['resolved_by'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_alerts_deleted_by_id', 'alerts', 'users', ['deleted_by_id'], ['id'], ondelete='SET NULL')

    op.add_column('ai_reports', sa.Column('bleeding_type', sa.String(length=100), nullable=True))
    op.add_column('ai_reports', sa.Column('icp_risk', sa.Enum('low', 'medium', 'high', name='icprisk'), nullable=True))
    op.add_column('ai_reports', sa.Column('herniation_risk', sa.Enum('low', 'medium', 'high', name='herniationrisk'), nullable=True))
    ...
    op.add_column('ai_reports', sa.Column('reviewed_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('ai_reports', sa.Column('is_reviewed', sa.Boolean(), server_default='0', nullable=False))
    op.add_column('ai_reports', sa.Column('is_deleted', sa.Boolean(), server_default='0', nullable=False))
    op.add_column('ai_reports', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True))
    ...
    op.add_column('ai_reports', sa.Column('fhir_resource_type', sa.String(length=50), nullable=True))
    op.add_column('ai_reports', sa.Column('fhir_id', sa.String(length=100), nullable=True))
    op.add_column('ai_reports', sa.Column('icd10_code', sa.String(length=20), nullable=True))
    op.add_column('ai_reports', sa.Column('snomed_ct_code', sa.String(length=20), nullable=True))
    op.add_column('ai_reports', sa.Column('loinc_code', sa.String(length=20), nullable=True))
    op.create_foreign_key('fk_ai_reports_reviewed_by', 'ai_reports', 'users', ['reviewed_by'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_ai_reports_deleted_by_id', 'ai_reports', 'users', ['deleted_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_ai_reports_created_by_id', 'ai_reports', 'users', ['created_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_ai_reports_updated_by_id', 'ai_reports', 'users', ['updated_by_id'], ['id'], ondelete='SET NULL')

    op.alter_column('knowledge_base', 'is_active', new_column_name='is_published')
    op.add_column('knowledge_base', sa.Column('is_deleted', sa.Boolean(), server_default='0', nullable=False))
    op.add_column('knowledge_base', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('knowledge_base', sa.Column('deleted_by_id', sa.Uuid(), nullable=True))
    op.add_column('knowledge_base', sa.Column('version', sa.Integer(), server_default='1', nullable=False))
    op.add_column('knowledge_base', sa.Column('created_by_id', sa.Uuid(), nullable=True))
    op.add_column('knowledge_base', sa.Column('updated_by_id', sa.Uuid(), nullable=True))
    op.add_column('knowledge_base', sa.Column('fhir_resource_type', sa.String(length=50), nullable=True))
    op.add_column('knowledge_base', sa.Column('fhir_id', sa.String(length=100), nullable=True))
    op.create_foreign_key('fk_knowledge_base_deleted_by_id', 'knowledge_base', 'users', ['deleted_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_knowledge_base_created_by_id', 'knowledge_base', 'users', ['created_by_id'], ['id'], ondelete='SET NULL')
    op.create_foreign_key('fk_knowledge_base_updated_by_id', 'knowledge_base', 'users', ['updated_by_id'], ['id'], ondelete='SET NULL')

    op.rename_table('knowledge_update_log', 'knowledge_update_logs')
    op.add_column('knowledge_update_logs', sa.Column('changes', sa.JSON(), nullable=True))
    op.drop_column('knowledge_update_logs', 'performed_by')
    op.add_column('knowledge_update_logs', sa.Column('performed_by', sa.Uuid(), nullable=True))
    op.alter_column('knowledge_update_logs', 'knowledge_id', nullable=False)
    op.create_foreign_key('fk_knowledge_update_logs_performed_by', 'knowledge_update_logs', 'users', ['performed_by'], ['id'], ondelete='SET NULL')

    op.add_column('audit_logs', sa.Column('correlation_id', sa.String(length=100), nullable=True))
    op.add_column('audit_logs', sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False))
    op.create_index(op.f('ix_audit_logs_correlation_id'), 'audit_logs', ['correlation_id'], unique=False)

    op.create_index('ix_sensor_readings_patient_timestamp', 'sensor_readings', ['patient_id', sa.text('timestamp DESC')])
    op.create_index('ix_sensor_readings_device_timestamp', 'sensor_readings', ['device_id', sa.text('timestamp DESC')])
    op.create_index('ix_sensor_readings_risk_level_timestamp', 'sensor_readings', ['risk_level', sa.text('timestamp DESC')])

    op.create_index('ix_alerts_patient_severity', 'alerts', ['patient_id', 'severity', sa.text('created_at DESC')])
    op.create_index('ix_alerts_unacknowledged', 'alerts', ['is_acknowledged', sa.text('created_at DESC')])
    op.create_index('ix_alerts_unresolved', 'alerts', ['is_resolved', sa.text('created_at DESC')])

    op.create_index('ix_ai_reports_patient_type', 'ai_reports', ['patient_id', 'report_type', sa.text('created_at DESC')])
    op.create_index('ix_ai_reports_risk_score', 'ai_reports', [sa.text('risk_score DESC')])

    op.create_index('ix_knowledge_base_category', 'knowledge_base', ['category'])
    op.create_index('ix_knowledge_base_published', 'knowledge_base', ['is_published', sa.text('created_at DESC')])

    op.create_index('ix_audit_logs_user_action', 'audit_logs', ['user_id', 'action', sa.text('created_at DESC')])
    op.create_index('ix_audit_logs_resource', 'audit_logs', ['resource', sa.text('created_at DESC')])
...
def downgrade() -> None:
    ...
    op.drop_index('ix_sensor_readings_risk_level_timestamp', table_name='sensor_readings')
    ...
    op.drop_constraint('fk_knowledge_update_logs_performed_by', 'knowledge_update_logs', type_='foreignkey')
    op.alter_column('knowledge_update_logs', 'knowledge_id', nullable=True)
    op.drop_column('knowledge_update_logs', 'performed_by')
    op.add_column('knowledge_update_logs', sa.Column('performed_by', sa.String(length=255), nullable=True))
    op.drop_column('knowledge_update_logs', 'changes')
    op.rename_table('knowledge_update_logs', 'knowledge_update_log')

    op.drop_constraint('fk_knowledge_base_updated_by_id', 'knowledge_base', type_='foreignkey')
    op.drop_constraint('fk_knowledge_base_created_by_id', 'knowledge_base', type_='foreignkey')
    op.drop_constraint('fk_knowledge_base_deleted_by_id', 'knowledge_base', type_='foreignkey')
    ...
    op.create_unique_constraint('uq_hospitals_license_number', 'hospitals', ['license_number'])
