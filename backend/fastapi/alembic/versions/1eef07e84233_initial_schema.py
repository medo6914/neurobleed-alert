...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "is_phone_verified", sa.Boolean(), server_default="0", nullable=False
        ),
        sa.Column("hospital_id", sa.Uuid(), nullable=True),
    ...
    op.create_index(
        op.f("ix_sensor_readings_patient_id"),
        "sensor_readings",
        ["patient_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_ai_reports_patient_id"), "ai_reports", ["patient_id"], unique=False
    )
