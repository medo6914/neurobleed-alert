...
def upgrade() -> None:
    ...
    op.add_column('knowledge_base', sa.Column('faiss_indexed', sa.Boolean(), server_default='0', nullable=False))
    op.add_column('knowledge_base', sa.Column('faiss_index_version', sa.Integer(), server_default='0', nullable=False))
